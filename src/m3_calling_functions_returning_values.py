...
def run_test_sum_of_digits():
    ...
    expected = 25
    answer = sum_of_digits(46825)
    print('Test 2 expected', expected)
    print('      actual:  ', answer)
    return answer
    expected = 35
    answer = sum_of_digits(6482735)
...
def run_test_digits_in_cube():
    ...
    Expected = 10
    Actual = sum_of_digits(4**3)
    print('Test 3 expected:', Expected)
    print('      actual:  ', Actual)
    print('-----------------------------------------------------')
    Expected = 19
    Actual = sum_of_digits(25**3)
    print('Test 4 expected:', Expected)
    print('         actual:', Actual)
    print('-----------------------------------------------------')
    Expected = 26
    Actual = sum_of_digits(41**3)
...
def run_test_digits_in_power():
    ...
    expected = 18
    actual = sum_of_digits(6**4)
    print('Test 1 expected:', expected)
    print('         actual:', actual)
    print('--------------------------------------------------')
    expected = 22
    actual = sum_of_digits(7**5)
    print('Test 2 expected:', expected)
    print('         actual:', actual)
    print('--------------------------------------------------')
    expected = 28
    actual = sum_of_digits(11**6)
    print('Test 3 expected:', expected)
    print('         actual:', actual)
...
def run_test_fancy_sums_of_digits():
    ...
    print('         actual:', actual)
    print('--------------------------------------------------')
    X = sum_of_digits(2 ** 1000)
    Y = sum_of_digits(2 ** 999)
    expected = 19084
    actual = sum_of_digits(X**Y)
    print('Test 2 expected:', expected)
    print('         actual:', actual)
